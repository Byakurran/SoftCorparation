...
public class AdminFinds extends javax.swing.JFrame {
...
String SQL = "SELECT * FROM \"PUBLIC\".SOFTCORPARATION";
    ...
    try {            
        ...
        Logger.getLogger(AdminFinds.class.getName()).log(Level.SEVERE, null, ex);
    }
    return userList;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminFinds.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    //</editor-fold>
    //</editor-fold>
    //</editor-fold>
    ...
    //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminFinds().setVisible(true);
            }
        });
    }
